...
```{r jeep}
carousel("jeep", yaml.load_file(here("posts", "jordan-wadi-rum", "media_data", "jeep_tour", "jeep_tour.yml")))
```
...
```{r rock-scramble}
carousel("rock-scramble", yaml.load_file(here("posts", "jordan-wadi-rum", "media_data", "rock_scramble", "rock_scramble.yml")))
```
