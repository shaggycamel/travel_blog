...
```{r}
destinations <- list(
  "Ohrid" = list(label="Ohrid", transport=NA, label_pos="bottom"),
  "Tirana" = list(label="Tirana", transport="car", label_pos="top")
)
...
```{r chilling}
# carousel("chilling", yaml.load_file(here("posts", "albania-tirana", "media_data", "chilling", "chilling.yml")))
```
