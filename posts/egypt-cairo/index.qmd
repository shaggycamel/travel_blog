...
```{r pyramids}
carousel("pmid", here("posts", "egypt-cairo", "media_data", "pyramids", "pyramids.yml"))
```
...
```{r museums}
carousel("msm", here("posts", "egypt-cairo", "media_data", "museums", "museums.yml"))
```
...
```{r islamic}
carousel("islamic", here("posts", "egypt-cairo", "media_data", "islamic", "islamic.yml"))
```
...
```{r coptic}
carousel("coptic", here("posts", "egypt-cairo", "media_data", "coptic", "coptic.yml"))
```
...
```{r wander}
carousel("wander", here("posts", "egypt-cairo", "media_data", "wander", "wander.yml"))
```
