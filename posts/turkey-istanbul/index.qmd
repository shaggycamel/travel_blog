...
```{r hagia}
carousel("hagia", here("posts", "turkey-istanbul", "media_data", "hagia_sophia", "hagia_sophia.yml"))
```
...
```{r princess}
carousel("princess", here("posts", "turkey-istanbul", "media_data", "princess_islands", "princess_islands.yml"))
```
...
```{r blue}
carousel("blue", here("posts", "turkey-istanbul", "media_data", "blue_mosque", "blue_mosque.yml"))
```
...
```{r çamlica}
carousel("çamlica", here("posts", "turkey-istanbul", "media_data", "çamlica_mosque", "çamlica_mosque.yml"))
```
...
```{r misc}
carousel("misc", here("posts", "turkey-istanbul", "media_data", "misc", "misc.yml"))
```
