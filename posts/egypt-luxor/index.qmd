...
format: 
  html:
    theme: 
      - pandoc
image: "./media_data/tour/_DSC2534.JPG"
---
...
```{r luxor_temple}
carousel("luxor_temple", yaml.load_file(here("posts", "egypt-luxor", "media_data", "luxor_temple", "luxor_temple.yml")))
```
...
```{r tour}
carousel("tr", yaml.load_file(here("posts", "egypt-luxor", "media_data", "tour", "tour.yml")))
```
...
```{r hot_air_balloon}
carousel("hot_air_balloon", yaml.load_file(here("posts", "egypt-luxor", "media_data", "hot_air_balloon", "hot_air_balloon.yml")))
```
...
```{r karnak_temple}
carousel("karnak_temple", yaml.load_file(here("posts", "egypt-luxor", "media_data", "karnak_temple", "karnak_temple.yml")))
```
