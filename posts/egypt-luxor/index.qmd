...
```{r luxor_temple}
carousel("luxor_temple", here("posts", "egypt-luxor", "media_data", "luxor_temple", "luxor_temple.yml"))
```
...
```{r tour}
carousel("tr", here("posts", "egypt-luxor", "media_data", "tour", "tour.yml"))
```
...
```{r hot_air_balloon}
carousel("hot_air_balloon", here("posts", "egypt-luxor", "media_data", "hot_air_balloon", "hot_air_balloon.yml"))
```
...
```{r karnak_temple}
carousel("karnak_temple", here("posts", "egypt-luxor", "media_data", "karnak_temple", "karnak_temple.yml"))
```
