...
```{r volleyball}
carousel("vball", yaml.load_file(here("posts", "egypt-dahab", "media_data", "volleyball", "volleyball.yml")))
```
...
```{r blue-hole}
carousel("bluehl", yaml.load_file(here("posts", "egypt-dahab", "media_data", "blue_hole", "blue_hole.yml")))
```
...
```{r hike}
carousel("hk", yaml.load_file(here("posts", "egypt-dahab", "media_data", "hike", "hike.yml")))
```
...
```{r misc}
carousel("misc", yaml.load_file(here("posts", "egypt-dahab", "media_data", "misc", "misc.yml")))
```
