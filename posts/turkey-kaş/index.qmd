...
format: 
  html:
    theme: 
      - pandoc
image: "./image_data/beach/_DSC3980.JPG"
---
...
```{r beach}
carousel("bch", yaml.load_file(here("posts", "turkey-kaş", "image_data", "beach", "beach.yml")))
```
...
```{r misc}
carousel("misc", yaml.load_file(here("posts", "turkey-kaş", "image_data", "misc", "misc.yml")))
```
