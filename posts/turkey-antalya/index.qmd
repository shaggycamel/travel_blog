...
```{r duden}
carousel("duden", here("posts", "turkey-antalya", "media_data", "duden_waterfall", "duden_waterfall.yml"))
```
...
```{r kursunlu}
carousel("kursunlu", here("posts", "turkey-antalya", "media_data", "kurşunlu_waterfall", "kurşunlu_waterfall.yml"))
```
...
```{r misc}
carousel("misc", here("posts", "turkey-antalya", "media_data", "misc", "misc.yml"))
```
