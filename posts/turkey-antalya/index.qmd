...
format: 
  html:
    theme: 
      - pandoc
image: "./media_data/misc/_DSC3540.JPG"
---
...
```{r duden}
carousel("duden", yaml.load_file(here("posts", "turkey-antalya", "media_data", "duden_waterfall", "duden_waterfall.yml")))
```
...
```{r kursunlu}
carousel("kursunlu", yaml.load_file(here("posts", "turkey-antalya", "media_data", "kurşunlu_waterfall", "kurşunlu_waterfall.yml")))
```
...
```{r misc}
carousel("misc", yaml.load_file(here("posts", "turkey-antalya", "media_data", "misc", "misc.yml")))
```
