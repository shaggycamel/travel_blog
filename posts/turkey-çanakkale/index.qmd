...
```{r çanakkale}
carousel("bch", yaml.load_file(here("posts", "turkey-çanakkale", "media_data", "çanakkale", "çanakkale.yml")))
```
...
```{r dawn}
carousel("dawn", yaml.load_file(here("posts", "turkey-çanakkale", "media_data", "dawn_service", "dawn_service.yml")))
```
