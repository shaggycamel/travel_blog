...
format: 
  html:
    theme: 
      - pandoc
image: "./media_data/20230501_131758.jpg"
---
...
```{r city}
carousel("city", yaml.load_file(here("posts", "bulgaria-plovdiv", "media_data", "city", "city.yml")))
```
...
```{r hike}
carousel("hke", yaml.load_file(here("posts", "bulgaria-plovdiv", "media_data", "hike", "hike.yml")))
```
...
{{< video https://youtu.be/9s9frMgUde0 >}}