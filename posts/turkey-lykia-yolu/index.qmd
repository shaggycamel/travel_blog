...
```{r day-one}
carousel("one_day", here("posts", "turkey-lykia-yolu", "media_data", "day1", "day1.yml"))
```
...
```{r day-two}
carousel("two_day", here("posts", "turkey-lykia-yolu", "media_data", "day2", "day2.yml"))
```
...
```{r day-three}
carousel("three_day", here("posts", "turkey-lykia-yolu", "media_data", "day3", "day3.yml"))
```
...
```{r day-four}
carousel("four_day", here("posts", "turkey-lykia-yolu", "media_data", "day4", "day4.yml"))
```
...
```{r day-five}
carousel("five_day", here("posts", "turkey-lykia-yolu", "media_data", "day5", "day5.yml"))
```
