...
author: "Oliver Eaton"
date: "2023-03-06"
categories: [Egypt, Aswan]
format: 
  html:
    theme: 
      - pandoc
image: "./image_data/felucca/_DSC2034.JPG"
---
...
```{r felucca}
carousel("flca", yaml.load_file(here("posts", "egypt-aswan", "image_data", "felucca", "felucca.yml")))
```
...
```{r noble_tombs_hike}
carousel("noble_tombs_hike", yaml.load_file(here("posts", "egypt-aswan", "image_data", "noble_tombs_hike", "noble_tombs_hike.yml")))
```
...
```{r abu_simbel}
carousel("abu_simbel", yaml.load_file(here("posts", "egypt-aswan", "image_data", "abu_simbel", "abu_simbel.yml")))
```
...
Maybe the constant _in-your-face_ nature of Egypt is wearing me down? - I wonder if Luxor will be different?

```{r misc}
carousel("misc", yaml.load_file(here("posts", "egypt-aswan", "image_data", "misc", "misc.yml")))
```
