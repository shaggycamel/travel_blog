...
```{r felucca}
carousel("flca", yaml.load_file(here("posts", "egypt-aswan", "media_data", "felucca", "felucca.yml")))
```
...
```{r noble_tombs_hike}
carousel("noble_tombs_hike", yaml.load_file(here("posts", "egypt-aswan", "media_data", "noble_tombs_hike", "noble_tombs_hike.yml")))
```
...
```{r abu_simbel}
carousel("abu_simbel", yaml.load_file(here("posts", "egypt-aswan", "media_data", "abu_simbel", "abu_simbel.yml")))
```
...
```{r misc}
carousel("misc", yaml.load_file(here("posts", "egypt-aswan", "media_data", "misc", "misc.yml")))
```
