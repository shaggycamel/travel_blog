...
```{r calcite_flats}
carousel("calcite_flats", yaml.load_file(here("posts", "turkey-pamukkale", "media_data", "calcite_flats", "calcite_flats.yml")))
```
...
```{r ruins}
carousel("ruins", yaml.load_file(here("posts", "turkey-pamukkale", "media_data", "ruins", "ruins.yml")))
```
