...
```{r mosque}
carousel("mosque", here("posts", "egypt-alexandria", "media_data", "mosque", "mosque.yml"))
```
...
```{r fish-market}
carousel("fish_market", here("posts", "egypt-alexandria", "media_data", "fish_market", "fish_market.yml"))
```
...
```{r qaitbey-fort}
carousel("qaitbey_fort", here("posts", "egypt-alexandria", "media_data", "qaitbey_fort", "qaitbey_fort.yml"))
```
...
```{r roman-theatre}
carousel("roman_theatre", here("posts", "egypt-alexandria", "media_data", "roman_theatre", "roman_theatre.yml"))
```
...
```{r catacombs}
carousel("catacombs", here("posts", "egypt-alexandria", "media_data", "catacombs", "catacombs.yml"))
```
...
```{r birthday}
carousel("birthday", here("posts", "egypt-alexandria", "media_data", "birthday", "birthday.yml"))
```
...
```{r misc}
carousel("misc", here("posts", "egypt-alexandria", "media_data", "misc", "misc.yml"))
```
