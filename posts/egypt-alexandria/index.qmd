...
format: 
  html:
    theme: 
      - pandoc
image: "./media_data/qaitbey_fort/_DSC1723.JPG"
---
...
```{r mosque}
carousel("mosque", yaml.load_file(here("posts", "egypt-alexandria", "media_data", "mosque", "mosque.yml")))
```
...
```{r fish-market}
carousel("fish_market", yaml.load_file(here("posts", "egypt-alexandria", "media_data", "fish_market", "fish_market.yml")))
```
...
```{r qaitbey-fort}
carousel("qaitbey_fort", yaml.load_file(here("posts", "egypt-alexandria", "media_data", "qaitbey_fort", "qaitbey_fort.yml")))
```
...
```{r roman-theatre}
carousel("roman_theatre", yaml.load_file(here("posts", "egypt-alexandria", "media_data", "roman_theatre", "roman_theatre.yml")))
```
...
```{r catacombs}
carousel("catacombs", yaml.load_file(here("posts", "egypt-alexandria", "media_data", "catacombs", "catacombs.yml")))
```
...
```{r birthday}
carousel("birthday", yaml.load_file(here("posts", "egypt-alexandria", "media_data", "birthday", "birthday.yml")))
```
...
```{r misc}
carousel("misc", yaml.load_file(here("posts", "egypt-alexandria", "media_data", "misc", "misc.yml")))
```
