...
format: 
  html:
    theme: 
      - pandoc
image: "./image_data/jerash/_DSC3438.JPG"
---
...
```{r citadel}
carousel("citadel", yaml.load_file(here("posts", "jordan-amman", "image_data", "citadel", "citadel.yml")))
```
...
```{r amphitheatre}
carousel("amphitheatre", yaml.load_file(here("posts", "jordan-amman", "image_data", "amphitheatre", "amphitheatre.yml")))
```
...
```{r onedeadsea}
carousel("onedeadsea", yaml.load_file(here("posts", "jordan-amman", "image_data", "onedeadsea", "onedeadsea.yml")))
```
...
```{r jerash}
carousel("jrsh", yaml.load_file(here("posts", "jordan-amman", "image_data", "jerash", "jerash.yml")))
```
...
```{r twodeadsea}
carousel("twodeadsea", yaml.load_file(here("posts", "jordan-amman", "image_data", "twodeadsea", "twodeadsea.yml")))
```
...
```{r misc}
carousel("misc", yaml.load_file(here("posts", "jordan-amman", "image_data", "misc", "misc.yml")))
```
