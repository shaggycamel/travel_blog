...
```{r citadel}
carousel("citadel", here("posts", "jordan-amman", "media_data", "citadel", "citadel.yml"))
```
...
```{r amphitheatre}
carousel("amphitheatre", here("posts", "jordan-amman", "media_data", "amphitheatre", "amphitheatre.yml"))
```
...
```{r onedeadsea}
carousel("onedeadsea", here("posts", "jordan-amman", "media_data", "onedeadsea", "onedeadsea.yml"))
```
...
```{r jerash}
carousel("jrsh", here("posts", "jordan-amman", "media_data", "jerash", "jerash.yml"))
```
...
```{r twodeadsea}
carousel("twodeadsea", here("posts", "jordan-amman", "media_data", "twodeadsea", "twodeadsea.yml"))
```
...
```{r misc}
carousel("misc", here("posts", "jordan-amman", "media_data", "misc", "misc.yml"))
```
