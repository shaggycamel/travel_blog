...
format: 
  html:
    theme: 
      - pandoc
image: "./media_data/misc/_DSC2705.JPG"
---
...
destinations <- list(
  ...
  "Nuweibaa" = list(label="Nuweibaa", transport="car", label_pos="top"),
...
```{r beach}
carousel("bch", yaml.load_file(here("posts", "jordan-aqaba", "media_data", "beach", "beach.yml")))
```
