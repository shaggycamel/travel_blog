...
format: 
  html:
    theme: 
      - pandoc
image: "./image_data/love_pigeon_valley_hike/_DSC3947.JPG"
---
...
```{r sunrise}
carousel("sunrs", yaml.load_file(here("posts", "turkey-cappadocia", "image_data", "sunrise", "sunrise.yml")))
```
...
```{r hike_red_valley}
carousel("hike_red_valley", yaml.load_file(here("posts", "turkey-cappadocia", "image_data", "red_valley_hike", "red_valley_hike.yml")))
```
...
```{r bike_red_valley}
carousel("bike_red_valley", yaml.load_file(here("posts", "turkey-cappadocia", "image_data", "red_valley_bike", "red_valley_bike.yml")))
```
...
```{r love_pigeon_hike}
carousel("love_pigeon_hike", yaml.load_file(here("posts", "turkey-cappadocia", "image_data", "love_pigeon_valley_hike", "love_pigeon_valley_hike.yml")))
```
