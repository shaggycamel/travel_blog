...
```{r black-desert}
carousel("blk", here("posts", "egypt-bahariya-oasis", "media_data", "black_desert", "black_desert.yml"))
```
...
```{r white-desert}
carousel("wht", here("posts", "egypt-bahariya-oasis", "media_data", "white_desert", "white_desert.yml"))
```
...
carousel("white-desert-overnight", here("posts", "egypt-bahariya-oasis", "media_data", "white_desert", "white_desert_overnight.yml"))
```
...
carousel("white-desert-sunrise", here("posts", "egypt-bahariya-oasis", "media_data", "white_desert", "white_desert_sunrise.yml"))
```
...
```{r misc}
carousel("misc", here("posts", "egypt-bahariya-oasis", "media_data", "misc", "misc.yml"))
```
