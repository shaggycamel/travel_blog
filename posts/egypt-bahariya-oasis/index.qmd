...
format: 
  html:
    theme: 
      - pandoc
image: "./media_data/black_desert/_DSC1409.JPG"
---
...
```{r}
destinations <- list(
  "Cairo" = list(label="Cairo", transport=NA, label_pos="right"),
  "Bahariya Oasis" = list(label="Bahariya Oasis", transport="car", label_pos="bottom")
)
...
```{r black-desert}
carousel("blk", yaml.load_file(here("posts", "egypt-bahariya-oasis", "media_data", "black_desert", "black_desert.yml")))
```
...
```{r white-desert}
carousel("wht", yaml.load_file(here("posts", "egypt-bahariya-oasis", "media_data", "white_desert", "white_desert.yml")))
```
...
carousel("white-desert-overnight", yaml.load_file(here("posts", "egypt-bahariya-oasis", "media_data", "white_desert", "white_desert_overnight.yml")))
```
...
carousel("white-desert-sunrise", yaml.load_file(here("posts", "egypt-bahariya-oasis", "media_data", "white_desert", "white_desert_sunrise.yml")))
```
...
```{r misc}
carousel("misc", yaml.load_file(here("posts", "egypt-bahariya-oasis", "media_data", "misc", "misc.yml")))
```
