...
```{r selçuk}
carousel("selçuk", here("posts", "turkey-izmir", "media_data", "selçuk", "selçuk.yml"))
```
...
```{r çeşme}
carousel("çeşme", here("posts", "turkey-izmir", "media_data", "çeşme", "çeşme.yml"))
```
...
```{r misc}
carousel("misc", here("posts", "turkey-izmir", "media_data", "misc", "misc.yml"))
```
