...
```{r one_petra}
carousel("one_petra", yaml.load_file(here("posts", "jordan-wadi-musa", "media_data", "petra_1", "petra_1.yml")))
```
...
```{r two_petra}
carousel("two_petra", yaml.load_file(here("posts", "jordan-wadi-musa", "media_data", "petra_2", "petra_2.yml")))
```
