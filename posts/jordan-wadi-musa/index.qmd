...
author: "Oliver Eaton"
date: "2023-03-24"
categories: [Jordan, Wadi Musa, Petra]
format: 
  html:
    theme: 
      - pandoc
image: "./image_data/petra_1/_DSC3133.JPG"
---
...
```{r one_petra}
carousel("one_petra", yaml.load_file(here("posts", "jordan-wadi-musa", "image_data", "petra_1", "petra_1.yml")))
```
...
```{r two_petra}
carousel("two_petra", yaml.load_file(here("posts", "jordan-wadi-musa", "image_data", "petra_2", "petra_2.yml")))
```

# Wrap up

Dana was our next destination, Trav scoped out a hike through a valley which looked awesome. We organised a taxi for 40JOD.
