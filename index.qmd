...
[[Click here to read the blog!]{.underline}](https://shaggycamel-travelblog.netlify.app/) - Alternatively, click "**Travel Blog**" in the top right hand corner 🤚. This summary page can be returned to by clicking "**Journey Summary**" in the top left hard corner ✋. Best viewing is on larger screens, such as a tablet, laptop or computer.
...
destinations <- list(
  ...
  "Izmir" = list(transport="car", point_colour="purple"),
  "Istanbul" = list(transport="car", point_colour="black")
)
