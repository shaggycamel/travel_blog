...
destinations <- list(
  ...
  "Sofia" = list(transport="car", point_colour="red"),
  "Skopje" = list(transport="car", point_colour="black")
)
...
m <- mapBliss::plot_hybrid_route(
  ...
  leaflet::addLegend(
    position = "topright",
    colors = c("blue", "green", "purple", "red", "orange", "black"),
    labels = c("Egypt", "Jordan", "Turkey", "Bulgaria", "North Macedonia", "Current Location"),
    opacity = 1
  )
